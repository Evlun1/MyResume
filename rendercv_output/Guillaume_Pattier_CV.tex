...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Avril 2026}\hspace{\widthof{Avril 2026}}
    }}}%
  }%
}%
...
\begin{document}
    ...
    \section{Expérience Professionnelle}
        ...
        Jan 2020 – présent
            ...
            \begin{highlights}
                \item \textbf{5 missions longues (→)} chez 4 clients (Hachette, Allianz Trade, Allianz France \& Canal+)
                \item \textbf{"Talent Manager" de 4 data scientists} confirmés, suivi régulier et entretiens annuels
        ...
        Jan 2026 – présent
            ...
            \textbf{→ Hachette}, Data Architect
            \begin{highlights}
                \item Élaboration chiffrage et stratégie de \textbf{migration d'une plateforme data legacy}
                \item Contribution aux documents de cahier des charges (RfP) éditeur \& intégrateur
                \item \textbf{Notation et synthèse} des propositions éditeur
                \item \textit{AWS (SageMaker), Azure (Fabric), GCP (BigQuery), Databricks, Snowflake}
            \end{highlights}
        \end{twocolentry}
        ...
        Oct 2022 – Juil 2025
            ...
            \begin{highlights}
                \item Développement \& maintenance d'une \textbf{plateforme data} sur mesure pour \textbf{100 DS}
        ...
        Jan 2021 – Sep 2022
            ...
            \begin{highlights}
                ...
                \item \textit{Python, PySpark, Luigi, Git, Gitlab CI, Metabase, SQL (PostGre)}
            \end{highlights}
        \end{twocolentry}
    ...
    \section{Compétences}
        ...
        \begin{onecolentry}
            \textbf{DevOps:} Git, GitLab CI, AWS, Terraform, Docker, Bash
        \end{onecolentry}
